...
export function LoginForm({ onSubmit, isLoading, error }: LoginFormProps) {
  ...
  const inputNormal = 'border-white/[0.12] focus:border-[rgba(167,139,250,0.7)] focus:shadow-[0_0_0_3px_rgba(167,139,250,0.15)]';
  const inputError = 'border-[rgba(248,113,113,0.7)] focus:border-[rgba(248,113,113,0.9)] focus:shadow-[0_0_0_3px_rgba(248,113,113,0.15)]';
  ...
  return (
    <>
      ...
      <p className="text-[0.875rem] text-white/50 m-0 mb-9">이메일과 PIN을 입력하여 인증번호를 조회합니다.</p>
      ...
      <div className="mb-5">
        <label className="block text-[0.75rem] font-medium text-white/55 tracking-[0.08em] uppercase mb-2">
          PIN 4자리
        </label>
        <motion.div variants={shakeVariants} animate={hasError ? 'shake' : 'rest'}>
