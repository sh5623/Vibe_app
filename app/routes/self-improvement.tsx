...
const INCIDENTS: Incident[] = [
  ...
  },
  {
    ...
    rule: '무조건 단언 금지 — 조건·예외를 명시하고, 쓰기 전 반례를 grep 한다',
  },
  {
  ...
  },
  {
    ...
    rule: '등록은 상시 로드 문서에 실제 경로를 쓴다 — 다음 탐색은 그 선언을 가장 먼저 읽는다',
  },
]
      ...
      <header className="relative pt-[9rem] pb-24 px-12 max-[768px]:pt-32 max-[768px]:pb-16 max-[768px]:px-6">
        ...
        >
          <div>
            ...
            >
              작업 중 규약·문서·절차에 물렸을 때 그 자리만 우회하지 않고, 증거 게이트를 통과한
              규약을 같은 세션이 스스로 고치는 자가개선 루프. FE·BE·스크립트·문서 — 어떤
              프로젝트에도 설치해 씁니다.
            </motion.p>
