...
const projects: Project[] = [
  ...
  },
  {
    ...
    desc: '한 명의 오케스트레이터가 격리된 git worktree 여러 개에서 서브에이전트를 병렬로 돌리고 순서대로 수확하는 Claude Code 스킬. 컨텍스트 적분 모델(c₀·n + g·n²/2)로 대기 시간의 비용을 정량화하고, 게이트가 green을 보고하며 조용히 실패하는 6가지 패턴을 문서화.',
    tags: ['Claude Code', 'git worktree', 'Markdown', 'Automation'],
    href: '/parallel-worktree',
  },
  {
    num: '04',
    name: 'Vibe App',
